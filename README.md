...
1. A token is someones personal identification that lets the computer know they have access to certain data.

- [ ] What steps can you take in your web apps to keep your data secure?

2. Some steps you can take are to make sure that authentication is working and each person is assigned a token and to set private routes accordingly.

- [ ] Describe how web servers work.

3. A server is what “serves us the websites we request in real time and the server is hosting the website.

- [ ] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.

4. We use .put and .delete to go through the Data
